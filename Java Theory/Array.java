...
class Array
{
    ...
    public void menu()
    {
        ...
        System.out.println("6. Steps to interchange values of two variables");
        System.out.println("7. Searching and sorting algorithm");
    ...
    /**
     * fn. to display steps to interchange values of two variables
     */
    public void interchange()
    {
        System.out.println();
        System.out.println();
        System.out.println("IMPORTANT TO KNOW");
        System.out.println("- STEPS TO INTERCHANGE VALUE OF 2 VARIABLES BY USING EXTRA VARIABLE");
        System.out.println("___________________________________________________________________");
        System.out.println("int a=10, b=20;");
        System.out.println("int t=a,       //t=10;");
        System.out.println("a=b;          //a=20");
        System.out.println("b=t;         //b=10");
        System.out.println("_________________________________________________________________");
        System.out.println();
        System.out.println();
        System.out.println();
        System.out.println("- STEPS TO INTERCHANGE VALUES OF TWO VARIABLES WITHOUT USING AN EXTRA VARIABLE");
        System.out.println("_____________________________________________________________________________");
        System.out.println("int a=10,b=20;");
        System.out.println("a=a+b;      //a=30;");
        System.out.println("b=a-b;      //b=30-20=10");
        System.out.println("a=a-b;      //a=20-10=20");
    ...
    public void sorting()
    {
        ...
        System.out.println("- repeat this process with n-1 times.");
